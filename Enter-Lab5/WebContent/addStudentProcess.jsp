...
connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/db1?useTimezone=true&serverTimezone=UTC", "root", "1234");	
	
		// Create a statement to retrieve objects
		statement = connection.createStatement();        
		
		// update results to the table 
		int stmt= statement.executeUpdate("insert into Student(name, department, password, english, math, science, malay) values('" + id + "', '" + dp + "', '"+ pw + "', '" + english + "', '" + math + "', '" + science +"')");
